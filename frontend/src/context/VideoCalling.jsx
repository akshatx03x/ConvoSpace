...
const VideoCalling = () => {
  ...
  if (!isJoined) {
    return (
      <div 
        className="w-full min-h-screen flex justify-center items-center p-4 pt-16" 
        style={{ 
          backgroundColor: THEME_MAIN_BG,
          marginTop: NAVBAR_HEIGHT 
        }}
      >
        <div className="w-[900px] h-[550px] rounded-[50px] overflow-hidden flex shadow-2xl" style={{ backgroundColor: THEME_LIGHT_CARD_BG }}>
    ...
    >
      <div className="flex-1 flex justify-center items-center p-4">
        <div className="flex w-full max-w-5xl h-[85vh] rounded-xl shadow-2xl overflow-hidden" style={{ backgroundColor: THEME_LIGHT_CARD_BG }}>
          ...
          <div className="flex flex-col w-3/4 p-6 space-y-6 justify-between border-l border-gray-300">
            ...
            <div className="flex justify-center p-3 space-x-4">
              ...
              <button className="px-6 py-3 text-white font-extrabold rounded-full shadow-lg" style={{ backgroundColor: THEME_ACCENT_COLOR }}>
                Mic/Camera
              </button>
              <button onClick={handleLeaveMeeting} className="px-6 py-3 bg-red-600 text-white font-extrabold rounded-full shadow-lg">
                End Call
              </button>
            </div>
          </div>
